...
def _scenario_design_markdown(catalog: pd.DataFrame) -> str:
    ...
    lines = ["# Scenario Design by Charging Adequacy", "", "`rho = fleet task energy demand / available WPT supply`.",
             ...
             "The uniform 0-175-mm eight-state misalignment assumption is retained. Final DES eta is the frozen nominal 3-kW SS-FHA matched curve for every scenario."]
    return "\n".join(lines) + "\n"
